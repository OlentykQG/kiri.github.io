...
$sql = "INSERT INTO `kiri-reports` (`report_message`)
...
$sql = "
INSERT INTO `kiri-reports` (`report_message`)
VALUES (:report_message)
";
$sth=$dbh->prepare($sql);
...
$sql = "
INSERT INTO `kiri-users` (`name`, `email`, `message`)
...
<head>
  ...
  <meta name="description"
        content="Find exactly who you like by using Kiri's powerful search and filters. View and chat with Kiri members from your neighborhood or around the globe.">
  ...
  <!-- Facebook Meta Tags -->
  <meta property="og:url" content="https://kiridating.com/">
  <meta property="og:type" content="website">
  <meta property="og:title" content="Kiri - Gay Dating & Chat">
  <meta property="og:description"
        content="Find exactly who you like by using Kiri's powerful search and filters. View and chat with Kiri members from your neighborhood or around the globe.">
  <meta property="og:image" content="https://kiridating.comundefined">

  <!-- Twitter Meta Tags -->
  <meta name="twitter:card" content="summary_large_image">
  <meta property="twitter:domain" content="kiridating.com">
  <meta property="twitter:url" content="https://kiridating.com/">
  <meta name="twitter:title" content="Kiri - Gay Dating & Chat">
  <meta name="twitter:description"
        content="Find exactly who you like by using Kiri's powerful search and filters. View and chat with Kiri members from your neighborhood or around the globe.">
  <meta name="twitter:image" content="https://kiridating.comundefined">
</head>
<body>
    ...
    <div class="block">
      ...
      <div class="block-item block-home active" data-block="#home">
        <h2 class="block-home-title">
          The world’s best social networking app for gay,
          bi, trans and queer people
        </h2>
        ...
        <div class="block-home-content">
          ...
          <source srcset="./images/about-photo.webp" type="image/webp">
            <source srcset="./images/about-photo.jpg" type="image/jpeg">
            <img src="./images/about-photo.jpg" alt="About Photos">
          </picture>
          </div>
          <div class="block-home-content-photo">
            <div class="wrapper-block-home-content-photo-img">
            <picture>
                <source srcset="./images/Screen.webp" type="image/webp">
                 <source srcset="./images/Screen.jpg" type="image/jpeg">
             <img class="block-home-content-photo-img"
                               src="./images/Screen.jpg" alt="About Photo">
            </picture>
             </div>
            <div class="block-home-content-photo-button">
              <picture>
                <source srcset="./images/profile2_1.webp" type="image/webp">
                <source srcset="./images/profile2_1.jpg" type="image/jpeg">
              <img class="block-home-content-photo-img" src="./images/profile2_1.jpg" alt="About Photo">

              </picture>
              <picture>
                  <source srcset="./images/Send.webp" type="image/webp">
                   <source srcset="./images/Send.jpg" type="image/jpeg">
                            <img class="block-home-content-photo-img-text" src="./images/Send.jpg" alt="About Text Image">
              </picture>
                ...
                <div class="block-home-content-app-btn">
                 ...
                 <picture>
                   <source srcset="./images/app-btn.webp" type="image/webp">
                    ...
                    <img class="desktop"
                         src="./images/app-btn.jpg"
                         alt="Play Market">
                   </picture>
                  <!--   <picture>
                        <source srcset="./images/app-btn-mobile.webp" type="image/webp">
                        <source srcset="./images/app-btn-mobile.jpg" type="image/jpeg">
                         <img class="mobile" src="./images/app-btn-mobile.jpg" alt="Play Market">
                   </picture>-->
                  </a>
                </div>
                <div class="block-home-content-google-btn">
                  <a href="#">
                     <picture>
                      ...
                      <!--  <picture>
                       <source srcset="./images/google-btn-mobile.webp" type="image/webp">
                       <source srcset="./images/google-btn-mobile.jpg" type="image/jpeg">
                        <img class="mobile" src="./images/google-btn-mobile.jpg" alt="Play Market">
                     </picture>-->
                  </a>
                </div>
              </div>
      ...
      <div class="block-item block-about" data-block="#about">
        ...
        <div class="wrapper-block-about-content">
          <div class="block-about-content-photo">
            ...
            <picture>
               <source srcset="./images/about-photo-1.webp" type="image/webp">
               <source srcset="./images/about-photo-1.jpg" type="image/jpeg">
                <img src="./images/about-photo-1.jpg" alt="About Photo">
              </picture>
            </div>
          </div>
          ...
          <div class="block-about-top-content">
            ...
            <p class="block-about-description">Since launching in 2021, Kiri has grown into the safest and largest
              social
              networking app for gay, bi, trans, and queer people that does not sell your data. We have millions of
              daily
              users who use our location-based technology in almost every country in every corner of the planet.</p>
            ...
            <h3 class="block-about-bottom-title">
              And we’re still trying to achieve perfection
            </h3>

            <p class="block-about-bottom-description">Kiri proudly represents a modern LGBTQ lifestyle that’s expanding
              into new platforms. From social issues to content, we’re continuing to pioneer innovative paths with a
              meaningful impact for our beloved community. At Kiri, we’ve created a safe space where you can discover,
              navigate, and connect to the beautiful world around you.</p>
            <p class="block-about-bottom-description-text">Embrace new connections. </p>
            <p class="block-about-bottom-text">Your friends at Kiri</p>
          </div>
        </div>
      </div>
      ...
      <div class="block-item block-help" data-block="#help">
          ...
          <div class="block-help-content-tabs">
            ...
            <div class="block-help-content-tab-item" data-helpchoose="guide">
              <div class="block-help-content-tab-item-front">
                <p class="block-help-content-tab-item-text">The Kiri Guide</p>
                <picture>
                   <source srcset="./images/help-1.webp" type="image/webp">
                   <source srcset="./images/help-1.jpg" type="image/jpeg">
                  ...
                  <picture>
                     ...
                     <source srcset="./images/help-1-mobile.jpg" type="image/jpeg">
              ...
              <div class="block-help-content-tab-item-content">
                <p class="block-help-content-tab-item-content-title">The Kiri Guide</p>
              ...
              <div class="block-help-content-tab-item-front">
                <p class="block-help-content-tab-item-text">Troubleshooting</p>
                  <picture>
                      ...
                      <source srcset="./images/help-2.jpg" type="image/jpeg">
                    ...
                    <picture>
                       <source srcset="./images/help-2-mobile.webp" type="image/webp">
                          <source srcset="./images/help-2-mobile.jpg" type="image/jpeg">
                ...
                <p class="block-help-content-tab-item-text">Safety and
                  Privacy</p>
                      <picture>
                        ...
                        <source srcset="./images/help-3.jpg" type="image/jpeg">
                      ...
                      <picture>
                         ...
                         <source srcset="./images/help-3-mobile.jpg" type="image/jpeg">
                         <img class="block-help-content-tab-img-mobile" src="./images/help-3-mobile.jpg" alt="Photo Help">
                       </picture>
              </div>
            </div>
            ...
            <div class="block-help-content-tab-item" data-helpchoose="support">
              <div class="block-help-content-tab-item-front">
                ...
                <picture>
                    ...
                    <source srcset="./images/help-4.jpg" type="image/jpeg">
                  ...
                  <picture>
                     ...
                     <source srcset="./images/help-4-mobile.jpg" type="image/jpeg">
        ...
        <div class="block-help-content-choose-tabs">
          ...
          <div class="block-help-content-choose-tab" data-aboutchoosetab="guide">
            <p class="block-help-content-title-tab">The Kiri Guide</p>
            <div class="block-help-content-row">

              <ul class="block-help-content-row-list guide">
                <li class="block-help-content-row-list-item minus" data-helpchooseitem="whatalpha">What is Kiri? <span
                  class="icon-plus"></span>
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="whatalpha">
                  <p class="block-help-content-row-container-text">What is Kiri, and how does the Kiri application
                    allow users to contact other users?</p>
                  <p class="block-help-content-row-container-text">Kiri is a geolocation-based social networking
                    application for the LGBTQ+ and broader community.&nbsp;
                    You can chat via Kiri's messaging system; the chats are transmitted within Kiri's platform. You
                    may send messages containing text, images, video, and voice.&nbsp; Upon opening the application,
                    you
                    are
                    presented with a grid, or cascade, of other members who are sorted by distance.&nbsp; Kiri
                    collects
                    your
                    location information within a 100m radius of accuracy.&nbsp; You have the option to "Show
                    Distance,"
                    which will display an approximate calculation of the distance between you and other members (i.e.
                    relative distance between one user to another).&nbsp; Even if "Show Distance" is off, your
                    relative
                    distance is used to arrange the cascade based on distance.</p>
                  <p class="block-help-content-row-container-text">You can select any profile in the cascade to view
                    that person's images, profile information, send a
                    message, or “Flirt” with another member.&nbsp; A Flirt is an emoji reaction people can send to one
                    another to indicate they are interested, in addition to or instead of sending a chat message.&nbsp;
                    You
                    can select certain filters to help identify people nearby that they may wish to interact with
                    (i.e.
                    age, body type, etc.).&nbsp; You may subscribe to our premium service which provides more
                    features,
                    including the ability to apply multiple filters.</p>
                  <p class="block-help-content-row-container-text">The "Explore" feature allows you to search in a
                    different geographic area (other than where the
                    searching user is located) to find new people to connect with within that other region. Everyone
                    has
                    the ability to search using Explore; however, only our premium service subscribers have the
                    ability
                    to interact (i.e. chat, favorite, etc.) with Kiri users found in Explore.&nbsp; Everyone on Kiri
                    has
                    the option of opting in to and out of appearing in Explore searches by toggling "Show me on
                    Explore
                    searches" from the Kiri settings page.</p>
                </li>
                <li class="block-help-content-row-list-item plus" data-helpchooseitem="creating">Creating an account
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="creating">
                  <p class="block-help-content-row-container-text">Welcome to Kiri! Below you'll find steps for getting
                    your profile off the ground. That said, if you're still having trouble getting started, get in touch
                    with us here.</p>
                  <p class="block-help-content-row-container-text">First things first, you’ll have to download the Kiri
                    app on your device:</p>
                  <ul class="block-help-content-row-container-list disc">
                    <li>iOS: Download
                      <a class="block-help-content-link"
                         href="https://apps.apple.com/us/app/alpha-gay-dating-chat/id1581642080">Kiri
                        here</a>
                    </li>
                    <li>Android: Download
                      <a class="block-help-content-link"
                         href="https://play.google.com/store/apps/details?id=com.alphadatingapp">Kiri
                        here</a>
                    </li>
                  </ul>
                  ...
                  <p class="block-help-content-row-container-text">Creating a Kiri account using your email is easy!
                  ...
                  <div class="terms-content-list">
                    ...
                    <p class="terms-text">2. Your device should notify you that Kiri wants to use Facebook.com to sign
                      in.</p>
                    <p class="terms-text">3. If you’ve selected Facebook from the login page and you do not already
                      have a Kiri account, you'll see a pop-up of our Terms of Service and Privacy Policy. </p>
                  ...
                  <p class="block-help-content-row-container-text">
                    ...
                    Once you've logged in and authorized your Facebook account for use, Kiri will log you in to your
                    profile
                  </p>
                  ...
                  <p class="block-help-content-row-container-text">If you choose to use your Google account to create
                    your Kiri account, here's what you need to do:
                  </p>
                  <div class="terms-content-list">
                    ...
                    <p class="terms-text">2. If you’ve selected Google from the login page and you do not already have
                      a Kiri account, you'll see a pop-up of our Terms of Service and Privacy Policy</p>
                  ...
                  <p class="block-help-content-row-container-text">
                    ...
                    Google account already exists in Kiri's account system, select the account you used to create the
                  ...
                  <div class="terms-content-list">
                    ...
                    <p class="terms-text">2. If you’ve selected Apple from the login page and you do not already have a
                      Kiri account, you'll see a pop-up of our Terms of Service and Privacy Policy.</p>
                    <p class="terms-text">3. Should you choose to accept, you’ll be able to proceed with creating the
                      account.</p>
                  ...
                  <p class="block-help-content-row-container-text">
                    ...
                    ID you used when creating your Kiri account
                  </p>
                ...
                <li class="block-help-content-row-list-item plus" data-helpchooseitem="alpha">Kiri Premium
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="alpha">
                  <p class="block-help-content-row-container-text">Your weekend is already booked: you’ve got a
                    meeting
                    ...
                    have your clients see you in the grid during a quick check on Kiri.</p>
                  <p class="block-help-content-row-container-text">Introducing KIRI PREMIUM, the most convenient and
                    discreet
                    experience ever, offering our most exclusive features:</p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Viewed Me</span>— See who's checking you out.
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Unsend</span>— Undo sent messages and photos.
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Incognito</span>— Browse without being seen.
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Typing Status</span>— Know when someone’s
                    messaging you
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Unlimited Profiles</span>— Always find a fresh
                    face.
                  </p>
                  <p class="block-help-content-row-container-text title-bold">
                    Newest features exclusive to Kiri+.
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Expiring Photos</span> — Send pics that
                    disappear from others’ phones after one 10-second view.
                  </p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Chat Translate</span>— Detects other users’
                    language and translates for you.
                  </p>
                  <p class="block-help-content-row-container-text title-bold">
                    And ALL these features come with Kiri Premium.
                  </p>
                  <p class="block-help-content-row-container-text">
             Endless possibility. Infinite connection. Total discretion. With Kiri Premium, nothing will delay your satisfaction any longer.
                  </p>
                  <p class="block-help-content-row-container-text">
                   KIRI PREMIUM is now available on iOS and Android.
                  </p>
                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="language">Language preferences
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="language">
                  <p class="block-help-content-row-container-text">Kiri is a global community connector, and we aim
                    to
                    provide a great experience for everyone. Here in this language article, you will find the
                    following:</p>
                  <p class="block-help-content-row-container-text title-bold">
                    Kiri supported languages
                  </p>
                  <p class="block-help-content-row-container-text">Kiri supports the following languages, based on
                    your
                    operating system:</p>
                  ...
                  <p class="block-help-content-row-container-text">
                    To change your Kiri language from English to another supported language, follow the steps below
                  ...
                  <p class="block-help-content-row-container-text">
                    ...
                    the
                    list for Kiri to appear in that language.
                  </p>
                ...
                <li class="block-help-content-row-list-item plus" data-helpchooseitem="building">Building your profile
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="building">
                  ...
                  <p class="block-help-content-row-container-text"> Expectations The Expectations
                    section of your profile gives other people an idea of what you're looking for on Kiri. There are
                  ...
                  <p class="block-help-content-row-container-text">Pronouns He/Him/His She/Her/Hers They/Them/Theirs
                    ...
                    profile
                    even more, by adding other social media profiles to your Kiri profile. If you choose to do this,
              ...
              <div class="block-help-content-row-wrapper guide">
                ...
                <div class="block-help-content-row-wrapper-container active" data-helpchoosecontent="whatalpha">
                  <p class="block-help-content-row-container-text">What is Kiri, and how does the Kiri application
                    allow users to contact other users?</p>
                  <p class="block-help-content-row-container-text">Kiri is a geolocation-based social networking
                    application for the LGBTQ+ and broader community. 
                    You can chat via Kiri's messaging system; the chats are transmitted within Kiri's platform. You
                    may send messages containing text, images, video, and voice.  Upon opening the application, you are
                    presented with a grid, or cascade, of other members who are sorted by distance.  Kiri collects your
                    location information within a 100m radius of accuracy.  You have the option to "Show Distance,"
                    which will display an approximate calculation of the distance between you and other members (i.e.
                    relative distance between one user to another).  Even if "Show Distance" is off, your relative
                    distance is used to arrange the cascade based on distance.</p>
                  <p class="block-help-content-row-container-text">You can select any profile in the cascade to view
                    that person's images, profile information, send a
                    message, or “Flirt” with another member.  A Flirt is an emoji reaction people can send to one
                    another to indicate they are interested, in addition to or instead of sending a chat message.  You
                    can select certain filters to help identify people nearby that they may wish to interact with (i.e.
                    age, body type, etc.).  You may subscribe to our premium service which provides more features,
                    including the ability to apply multiple filters.</p>
                  <p class="block-help-content-row-container-text">The "Explore" feature allows you to search in a
                    different geographic area (other than where the
                    searching user is located) to find new people to connect with within that other region. Everyone has
                    the ability to search using Explore; however, only our premium service subscribers have the ability
                    to interact (i.e. chat, favorite, etc.) with Kiri users found in Explore.  Everyone on Kiri has
                    the option of opting in to and out of appearing in Explore searches by toggling "Show me on Explore
                    searches" from the Kiri settings page.</p>
                </div>
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="alpha">
                  <p class="block-help-content-row-container-text">Your weekend is already booked: you’ve got a meeting
                    with clients in an 1 hour, drinks at brunch with friends after, and a flight to Miami in the
                    morning. When it comes to your success, every minute counts, and you can’t afford to waste time—or
                    have your clients see you in the grid during a quick check on Kiri.</p>
                  <p class="block-help-content-row-container-text">Introducing KIRI PREMIUM, the most convenient and discreet
                    experience ever, offering our most exclusive features:</p>
                  <p class="block-help-content-row-container-text">
                    <span
                      class="block-help-content-row-container-text-bold">Viewed Me</span>— See who's checking you out.
             ...
             Endless possibility. Infinite connection. Total discretion. With Kiri Premium, nothing will delay your satisfaction any longer.
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="language">
                  <p class="block-help-content-row-container-text">Kiri is a global community connector, and we aim to
                    provide a great experience for everyone. Here in this language article, you will find the
                    following:</p>
                  <p class="block-help-content-row-container-text title-bold">
                    Kiri supported languages
          ...
          <div class="block-help-content-choose-tab" data-aboutchoosetab="troubleshooting">
            ...
            <div class="block-help-content-row">
              ...
              <ul class="block-help-content-row-list troubleshooting">
                <li class="block-help-content-row-list-item minus" data-helpchooseitem="report">Report a bug
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="report">
                  ...
                  <p class="block-help-content-row-container-text">We’re sorry that you’re running into a potential
                    bug
                    on Kiri. If the issue is something that’s already on our radar, you’ll see a blue banner atop
                    this
                ...
                <textarea class="block-help-form-input"
                         name="name"
                       placeholder="Write your message here"
                         autocomplete="off"
                         required="" oninput="auto_grow(this)"></textarea>
                ...
                <li class="block-help-content-row-list-item plus" data-helpchooseitem="censored">Censored countries &
                  regions
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="censored">
                  ...
                  <p class="block-help-content-row-container-text"> We recommend either contacting the network
                    ...
                    this is indeed the issue. Internet censorship may prevent members from accessing Kiri in the
                  ...
                  <p class="block-help-content-row-container-text">Using a VPN here will unfortunately not work,
                    because
                    Kiri is unavailable in these territories for the time being.</p>
                  <ul class="block-help-content-row-container-list disc">
                    <li>Iran</li>
                  ...
                  <p class="block-help-content-row-container-text title-bold">Countries where Kiri is delisted from
                    the
                    app store:</p>
              ...
              <div class="block-help-content-row-wrapper troubleshooting">
                ...
                <div class="block-help-content-row-wrapper-container active" data-helpchoosecontent="report">
                  ...
                  <p class="block-help-content-row-container-text">We’re sorry that you’re running into a potential bug
                    on Kiri. If the issue is something that’s already on our radar, you’ll see a blue banner atop this
                    page with a status update. If you aren’t seeing this banner, please report what you’re seeing here. 
                    We appreciate you making a report any time you suspect that you’ve found a bug. Ringing that alarm
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="censored">
                  ...
                  <p class="block-help-content-row-container-text title-bold">Countries where Kiri is delisted from the
                    app store:</p>
                  <p class="block-help-content-row-container-text"> Saudi Arabia
                    Note: If you choose to use a VPN please check local laws about VPN usage.
                  </p>
          ...
          <div class="block-help-content-choose-tab" data-aboutchoosetab="safety">
            ...
            <div class="block-help-content-row">
              <ul class="block-help-content-row-list safety">
                ...
                <li class="block-help-content-row-list-item minus" data-helpchooseitem="protect">Protect your identity
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="protect">
                  <p class="block-help-content-row-container-text"> Protecting your identity and personal information
                    is
                  ...
                  <ul class="block-help-content-row-container-list disc">
                    <li>Do NOT post any personal information to your public profile (phone number, address, where you
                      work)
                    </li>
                    <li>Only share information with users that you can trust. </li>
                    <li>Do NOT provide any financial information to other users.</li>
                    <li>Be aware of phishing and romance scams.</li>
                    <li>SMS Verifications sent to you by Kiri are ONLY for you and should not be shared with anyone
                      else.
                    </li>
                    <li>If you do not feel comfortable using a face picture for your profile, consider a photo that
                      represents you differently (know that it is possible to do a search of the photo and find any
                      other sites where you have posted it).
                    </li>
                    <li>Be cautious when connecting your social media accounts to your Kiri profile.
                    </li>
                    <li>Be aware of our In-App Privacy Features
                    </li>
                  </ul>

                  <p class="block-help-content-row-container-text">We encourage you to connect and help us to build a
                    safe and inclusive community.</p>

                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="secure">Secure your account
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="secure">
                  <p class="block-help-content-row-container-text">It’s smart to protect your account by using a
                    unique
                    password on Kiri that is hard to guess, plus utilizing our PIN code feature. We also offer
                    discreet
                    app icons (DAI). </p>
                  <p class="block-help-content-row-container-text">Please understand that people may save and/or share
                    the private information you share in chat such as messages or photos.
                  </p>
                  <p class="block-help-content-row-container-text">If you are on an untrusted WiFi network, consider
                    using a VPN to connect to Kiri, but you should check local laws before doing so.
                  </p>
                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="beAware">Be aware of location
                  features
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="beAware">
                  <p class="block-help-content-row-container-text">From your settings page, you can choose if
                    you want to “Show Distance” in other users’ grid views. By deselecting “show distance”, your
                    distance from other people will not be displayed. However, your profile will be visible to other
                    people in the grid, sorted by your distance from them, so an approximate distance may be inferred.
                    Kiri only collects your information within a 100-meter radius of accuracy. Sometimes this could
                    be
                    very close to where you are and sometimes this could be nearly 100 meters off of your actual
                    location.
                  </p>
                  <p class="block-help-content-row-container-text">If you do not wish to show your approximate
                    distance,
                    you can always go into your device’s settings and turn off location sharing altogether. In certain
                    regions of the world, being a member of the LGBTQ community is illegal. In those areas, Kiri may
                    automatically obscure user’s locations, or even have this feature turned off completely.
                  </p>
                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="beAwareTraveling">Be aware when
                  traveling
                </li>
                <li class="block-help-content-row-wrapper-container-mobile"
                     data-helpchoosecontentmobile="beAwareTraveling">
                  <p class="block-help-content-row-container-text">If you travel to a new place, research the local
                    laws. Unfortunately, in some countries where being LGBTQ+ is criminalized, law enforcement has
                    been
                    known to use social media apps as tools for potential entrapment. Some countries have laws that
                    even
                    criminalize communications between people on LGBTQ+ networks.
                  </p>
                  <p class="block-help-content-row-container-text">If you’re in an area that might be unsafe, use the
                    highest level of caution and reference local human rights organizations for further assistance.
                  </p>
                  <p class="block-help-content-row-container-text">Note: You can read all about which
                    countries/regions
                    have banned Kiri here.
                  </p>

                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="rush">Don't rush into things
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="rush">
                  <p class="block-help-content-row-container-text">Try chatting via phone or video chat before meeting
                    in person. Even when chatting online, be cautious about what you share. You may want to first
                    verify
                  ...
                  <p class="block-help-content-row-container-text">Although Kiri works hard to ban scammers quickly,
                    ...
                    quickly, as they know they will be blocked from Kiri soon. In general, we recommend keeping
                    communication on Kiri until you’re completely comfortable.
                  </p>
                  <p class="block-help-content-row-container-text">Sharing your location or home address can be risky,
                    do so only when you feel comfortable, and don't feel pressured if the other person has already
                    sent
                    you their location (as it may not be their actual location and they may be using it to bait you
                    into
                  ...
                  <p class="block-help-content-row-container-text">If you do choose to meet, we recommend you do so in
                    ...
                    you take with you. Know your limits with alcohol, don’t accept any strange drinks or drugs, and
                    keep
                  ...
                  <p class="block-help-content-row-container-text">Make sure a responsible person you trust knows who
                    ...
                    contact information. Finally, make sure you’re in charge of your own transportation and have a
                    plan
                    to get home.
                  </p>
                ...
                <li class="block-help-content-row-list-item plus" data-helpchooseitem="practice">Practice safer sex
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="practice">
                  <p class="block-help-content-row-container-text">Don’t let anyone make you feel that your sexuality
                    is
                    abnormal. Don’t let anyone body-shame you or tell you what you like isn’t best for you. And don’t
                    let anyone pressure you into having sex if you do not wish to do so. Likewise, be sure to ask for
                    consent before sex, and be respectful of boundaries. Consent can be withdrawn at any time, and sex
                    is never owed to anyone.
                  </p>
                  <p class="block-help-content-row-container-text">Practice safer sex and get tested for HIV and other
                    STIs regularly. Always have conversations with the people you meet about your safety expectations.
                  </p>
                  <p class="block-help-content-row-container-text">Read our Sexual Health Resource guide for more
                    information. </p>
                </li>

                <li class="block-help-content-row-list-item plus" data-helpchooseitem="utilize">Utilize the block &
                  report feature
                </li>
                <li class="block-help-content-row-wrapper-container-mobile" data-helpchoosecontentmobile="utilize">
                  <p class="block-help-content-row-container-text">If someone is making you feel uncomfortable on the
                    ...
                    violating our <a class="block-help-content-link"
                                     href="https://www.grindr.com/community-guidelines/?lang=en-US">Community
                  ...
                  <p class="block-help-content-row-container-text">Even if you follow all of our tips, no harm
                    reduction
                    plan is perfect. If you would like to report an incident that happened off Kiri, let us know at
                    <a class="block-help-content-link" href="mailto:help@grindr.com"></a>help@Kiri.com. You
                  ...
                  <p class="block-help-content-row-container-text">
                    If you do meet someone in person: plan an outside activity, wear masks, and stay socially
                    distanced.
                  </p>
                  <p class="block-help-content-row-container-text">
                    For more tips related to COVID-19, visit the
                    <a class="block-help-content-link"
                       href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public">WHO
              ...
              <div class="block-help-content-row-wrapper safety">
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="secure">
                  <p class="block-help-content-row-container-text title-bold">Secure your account</p>
                  <p class="block-help-content-row-container-text">It’s smart to protect your account by using a unique
                    password on Kiri that is hard to guess, plus utilizing our PIN code feature. We also offer discreet
                    app icons (DAI). </p>
                  <p class="block-help-content-row-container-text">Please understand that people may save and/or share
                    the private information you share in chat such as messages or photos.
                  </p>
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="beAware">
                  <p class="block-help-content-row-container-text title-bold">Be aware of location features</p>
                  <p class="block-help-content-row-container-text">From your settings page, you can choose if
                    you want to “Show Distance” in other users’ grid views. By deselecting “show distance”, your
                    distance from other people will not be displayed. However, your profile will be visible to other
                    people in the grid, sorted by your distance from them, so an approximate distance may be inferred.
                    Kiri only collects your information within a 100-meter radius of accuracy. Sometimes this could be
                    very close to where you are and sometimes this could be nearly 100 meters off of your actual
                    location.
                  </p>
                  <p class="block-help-content-row-container-text">If you do not wish to show your approximate distance,
                    you can always go into your device’s settings and turn off location sharing altogether. In certain
                    regions of the world, being a member of the LGBTQ community is illegal. In those areas, Kiri may
                    automatically obscure user’s locations, or even have this feature turned off completely.
                  </p>
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="beAwareTraveling">
                  <p class="block-help-content-row-container-text title-bold">Be aware when traveling</p>
                  <p class="block-help-content-row-container-text">If you travel to a new place, research the local
                    laws. Unfortunately, in some countries where being LGBTQ+ is criminalized, law enforcement has been
                    known to use social media apps as tools for potential entrapment. Some countries have laws that even
                    criminalize communications between people on LGBTQ+ networks.
                  </p>
                  <p class="block-help-content-row-container-text">If you’re in an area that might be unsafe, use the
                    highest level of caution and reference local human rights organizations for further assistance.
                  </p>
                  <p class="block-help-content-row-container-text">Note: You can read all about which countries/regions
                    have banned Kiri here.
                  </p>
                ...
                <div class="block-help-content-row-wrapper-container" data-helpchoosecontent="practice">
                  <p class="block-help-content-row-container-text title-bold">Practice safer sex</p>
                  <p class="block-help-content-row-container-text">Don’t let anyone make you feel that your sexuality is
                    abnormal. Don’t let anyone body-shame you or tell you what you like isn’t best for you. And don’t
                    let anyone pressure you into having sex if you do not wish to do so. Likewise, be sure to ask for
                    consent before sex, and be respectful of boundaries. Consent can be withdrawn at any time, and sex
                    is never owed to anyone.
            ...
            <div class="block-help-content-row">
              <form method="POST" class="form-support" id="submit-support-form" autocomplete="off">
                <div class="wrapper-support-fields">
                  ...
                  <input class="block-help-form-support-input"
                         type="text"
                         id="name"
                         name="name"
                  ...
                  <input
                    class="block-help-form-support-input"
                    type="text"
                    id="email"
                    name="email"
                  ...
                  <textarea
                    class="block-help-form-support-textarea"
                    name="message"
                    id="message"
                    cols="50"
                    rows="3"
      ...
      <div class="block-item block-alpha" data-block="#kiri">
        <h3 class="block-alpha-title"> Kiri Premium
        </h3>

        <div class="block-alpha-content">
          <div class="block-alpha-content-description">
            <p class="block-alpha-content-text">Your weekend is already booked: you’ve got a meeting with clients in an
              1 hour, drinks at brunch with friends after, and a flight to Ibiza in the morning. When it comes to your
              success, every minute counts, and you can’t afford to waste time—or have your clients see you in the grid
              during a quick check on Kiri.</p>


            <p class="block-alpha-content-text">Introducing KIRI PREMIUM, the most convenient and discreet experience ever,
              offering our most exclusive features:</p>
            <div class="block-alpha-content-photo-mobile">
              <div class="wrapper-block-alpha-content-photo-img">
              <picture>
              <source srcset="./images/Screen.webp" type="image/webp">
                <img class="block-alpha-content-photo-img"
                     src="./images/Screen.webp" alt="About Photo">
                     </picture>
                     </div>
              ...
              <picture>
                  <source srcset="./images/profile2_1.webp" type="image/webp">
              <img class="block-alpha-content-photo-img" src="./images/profile2_1.webp" alt="About Photo">
</picture>
   <picture>
                <source srcset="./images/Send.webp" type="image/webp">
                <img class="block-alpha-content-photo-img-text" src="./images/Send.webp" alt="About Text Image">
                </picture>
              </div>
            </div>
            <ul class="block-alpha-content-list">
              <li>View Me<span>See who’s checking you out.</span></li>
              <li>Unsend<span>Undo sent messages and photos.</span></li>
              <li>Collaborating Playfully<span>Work hard, play hard—it’s all about balance.</span></li>
              <li>Incognito<span>Browse without being seen.</span></li>
              <li>Typing Status<span>Know when someone’s messaging you.</span></li>
              <li>Unlimited Profiles<span>Always find a fresh face.</span></li>
              <li>Expiring Photos<span>Send pics that disappear from others’ phones after one 10-second view.</span>
              </li>
              <li>Chat Translate<span>Detects other users’ language and translates for you.</span></li>
            </ul>

            <p class="block-alpha-content-medium-title">And ALL these features come with  Kiri Premium</p>
            <p class="block-alpha-content-text">Endless possibility. Infinite connection. Total discretion. With KIRI PREMIUM nothing will delay your satisfaction any longer.</p>
            <p class="block-alpha-content-text">Kiri is now available on iOS and Android.</p>
          </div>
      ...
      <div class="block-item block-blog" data-block="#blog">
        ...
        <div class="wrapper-block-blog-content">
          ...
          <div class="block-blog-content">
            ...
            <picture>
            <source srcset="./images/blog-bg-photo.webp" type="image/webp">
                        <img class="block-blog-content-img" src="./images/blog-bg-photo.webp" alt="Blog Photo">
            </picture>
              <picture>
                        <source srcset="./images/blog-bg-photo-mobile.webp" type="image/webp">
            <img class="block-blog-content-img-mobile" src="./images/blog-bg-photo-mobile.webp" alt="Blog Photo">
                        </picture>
          </div>
        </div>
      </div>
      ...
      <div class="block-item block-alpha-for-equality" data-block="#alphaForEquality">
        ...
        <div class="block-alpha-for-equality-content">
          <div class="block-alpha-for-equality-content-wrapper">
            ...
            <picture>
                  <source srcset="./images/alpha-for-equality.webp" type="image/webp">
                  <img class="block-alpha-for-equality-content-img" src="./images/alpha-for-equality.webp" alt="Blog Photo">
            </picture>
            </div>
          ...
          <div class="block-alpha-for-equality-content-description">
            <h4 class="block-alpha-for-equality-title">Kiri for Equality
            </h4>
            <p class="block-alpha-for-equality-content-text">
              Kiri for Equality is an ever-evolving mission to help LGBTQ people around the globe. Our wide-ranging initiatives impact communities large and small on issues that matter to them the most: safety, sexual health, advocacy, and more.
            </p>
            <div>
              <div class="block-alpha-for-equality-content-wrapper-mobile">
                ...
                <picture>
                <source srcset="./images/alpha-for-equality.webp" type="image/webp">
                    <img class="block-alpha-for-equality-content-img" src="./images/alpha-for-equality.webp"
                                       alt="Blog Photo">
                </picture>
            ...
            <p class="block-alpha-for-equality-content-medium-title">Now is
              <span>the time</span>
              <span>to mobilize</span></p>
            <p class="block-alpha-for-equality-content-text">
Now is the time to inform and empower our communities. Because when we do, our voices get heard. Explore what G4E has been up to, and find out how you can get in on it.            </p>
          </div>
        </div>
      ...
      <div class="block-item block-careers" data-block="#careers">
        <div class="block-careers-content">
          <div class="block-careers-content-wrapper">
            ...
            <picture>
            <source srcset="./images/careers.webp" type="image/webp">
                          <img class="block-careers-content-img" src="./images/careers.webp" alt="Careers Photo">
            </picture>
            </div>
          </div>
          <div class="block-careers-content-description">
            <h4 class="block-careers-title">Careers
            </h4>
            <p class="block-careers-content-text">
              Start your successful career with Kiri team.
            </p>
            ...
            <ul class="block-careers-content-list">
              <li>Serving Bravely <span>Being queer takes guts—our users inspire us to be accountable and act for change.</span>
              </li>
              ...
              <li>Being Our Authentic Selves<span>Do you, boo—Kiri is a safe, supportive, and inclusive space.</span>
              </li>
            </ul>
      ...
      <div class="block-item block-terms-of-service" id="terms" data-block="#termsOfService">
        <div class="block-terms-of-service-content">
          <h4 class="block-terms-of-service-title">Kiri Terms and
            Conditions of Use
          </h4>


          <p class="terms-text">Welcome to Kiri ’s Terms and Conditions of Use (these “Terms”). This is a
            contract between you and the Kiri Group (as defined further below) and we want you to know
            yours and our rights before you use the Kiri application (“Kiri ” or the “App”). Please
            take a
            few moments to read these Terms before enjoying the App, because once you access, view or
            use
            the App, you are going to be legally bound by these Terms (so probably best to read them
            first!).
          </p>
          <p class="terms-text">
            Please be aware that if you subscribe to services for a term (the “Initial Term”), then the
            terms of your subscription will be automatically renewed for additional periods of the same
            duration as the Initial Term at Kiri ’s then-current fee for such services, unless you
            cancel
            your subscription in accordance with Section 5 below.
          </p>
          <p class="terms-text">
            You should also note that Section 13 of these Terms contains provisions governing how claims
            that you and Kiri Group have against each other are resolved. In particular, it contains an
            arbitration agreement that will, with limited exceptions, require disputes between us to be
            submitted to binding and final arbitration. If you are an existing user or a new user who
            signed
            up for Kiri before January 18, 2021, you have a right to opt out of the arbitration
            agreement
            pursuant to Section 13 below. If you do not opt out of the arbitration agreement in
            accordance
            with Section 13, or if you sign up for Kiri after January 18, 2021, (1) you will only be
            permitted to pursue claims and seek relief against us on an individual basis only; and (2)
            you
            are waiving your right to seek relief in a court of law and to have a jury trial on your
            claims.
          </p>
          <p class="terms-text">
            ...
            you
            subscribed using your Apple ID, refunds are handled by Apple, not Kiri . If you wish to
            request
            ...
            Store account or through Kiri, please contact <a class="terms-link"
                                                              href="mailto:support@kiriapp.com">Customer
            support.</a>
          </p>


          <!--  -->
          <p class="terms-describe">1. Kiri Rules</p>
          <p class="terms-text">
          ...
          <p class="terms-text"> You can create an Account via manual registration, or by using your
            ...
            about what information we use and how we use it, please check out our <a class="terms-link privacy"
                                                                                     href="https://kiridating.com/privacy.php">Privacy
              Policy.</a></p>
          ...
          <p class="terms-text">
            You’ll have great fun on Kiri , but if you feel the need to leave, you can delete your
          ...
          <ul class="terms-content-list disc">
            ...
            <li class="terms-content-list-item">content that the Kiri Group provides (“Our Content”).</li>
          </ul>
          <p class="terms-title">
            There is certain content we can’t allow on Kiri</p>
          <p class="terms-text"> We want our users to be able express themselves as much as possible and
            post all sorts of
            things on Kiri, but we have to impose restrictions on certain content which:</p>
          ...
          <ul class="terms-content-list disc">
            ...
            <li class="terms-content-list-item"> contains any spyware, adware, viruses, corrupt files,
              ...
              data
              or personal information whether from Kiri or otherwise;
            </li>
            <li class="terms-content-list-item">
            ...
            <li class="terms-content-list-item">
              ...
              <p class="terms-text">   Kiri Group operates a zero-tolerance policy for this kind of content.</p>

          <p class="terms-describe-title">Your Content</p>
          <p class="terms-text">
            You agree that Your Content must comply with our Guidelines at <a class="terms-link"
                                                                              href="mailto:support@kiriapp.com">
            https://Kiri
          ...
          <p class="terms-text">
            As Kiri is a public community, Your Content will be visible to other users of the App all
            ...
            link to a user’s profile or shared content from other Kiri Users). By uploading Your
            Content on Kiri , you represent and warrant to us that you have all necessary rights and
          ...
          <!--  -->
          <p class="terms-describe-title">Member Content</p>
          <p class="terms-text">
            Other members of Kiri will also share content via the App. Member Content belongs to the
          ...
          <p class="terms-text">
            ...
            other Kiri users’ personal information to the extent that your use of it matches Kiri ’s
          ...
          <!-- -->
          <p class="terms-describe-title">Our Content</p>
          <p class="terms-text">
            You may be wondering what happens to the rest of the Content on Kiri .
            ...
            appearing on Kiri are owned, controlled or licensed by us and are
          ...
          <!---->
          <div class="terms-content-list">
            <p class="terms-text"> 1. you shall not use, sell, modify, or distribute Our Content except as
              permitted by the functionality of the App;</p>
            <p class="terms-text"> 2. you shall not use our name in meta tags, keywords and/or hidden
              text;</p>
            <p class="terms-text"> 3. you shall not create derivative works from Our Content or
              commercially exploit Our Content, in whole or in part, in any way;</p>
            <p class="terms-text"> 4. you shall use Our Content for lawful purposes only.</p>
          </div>
          <p class="terms-text">
          ...
          <p class="terms-text">
            Since Kiri is an online community, we generally try to avoid getting in
          ...
          <p class="terms-text">
            We don’t like users misbehaving in the Kiri community. You can report
          ...
          <p class="terms-text">
            You understand that Kiri group does not currently conduct criminal background checks on its users. Kiri
            group also does not unquire into the background of its users or attempt to verify the statements of its
            users. Kiri group makes to verify the statements or warranties as to the conduct or future users. Kiri
          ...
          <p class="terms-text">
            You agree to, and hereby do, release Kiri Group and its successors
            ...
            for any unconscionable commercial practice by Kiri Group or for such
          ...
          <p class="terms-text">
            For information about how the Kiri Group collects, uses, and shares
            your personal data, please check out our     <a class="terms-link privacy"
                                                                                                                                                        href="https://kiridating.com/privacy.php">Privacy
                                                                                 Policy.</a> By using Kiri ,
            you acknowledge that we may use such data in accordance with our
            <a class="terms-link privacy"
                                                                                                 href="https://kiridating.com/privacy.php">Privacy
                          Policy.</a>
          </p>
          <!-- -->
          ...
          <p class="terms-text">
            Kiri may offer products and services for purchase on the App (“In-App
          ...
          <p class="terms-text">
            <span class="terms-describe-title">Subscriptions and Auto-Renewal:</span> Kiri may offer some services as
            ...
            <span class="terms-describe-title">IF YOU PURCHASE AN AUTOMATICALLY RENEWING SUBSCRIPTION,
                        ...
                        UNLESS YOU CANCEL, AT Kiri ’S THEN-CURRENT PRICE FOR
            ...
            subscribed and an opportunity to cancel. If Kiri changes these prices
            and you do not cancel your subscription, you agree that you will be charged
            at Kiri ’s then-current pricing for subscription
          </p>
          <p class="terms-describe-title">Cancelling Subscriptions.</p>

          <p class="terms-text">
            If you purchased a subscription directly from
            Kiri , you may cancel or change your Payment Method via the payment
          ...
          <p class="terms-text"> Generally, all charges for purchases are nonrefundable, and
            there are no refunds or credits for partially used periods.</p>
          ...
          <p class="terms-text">
            ...
            you are unable to use Kiri ) before the end of your subscription period,
          ...
          <p class="terms-text">
            ...
            subscribed using your Apple ID, refunds are handled by Apple, not Kiri.
          </p>
          <p class="terms-text">
          ...
          <p class="terms-text">
            For all other purchases: please contact <a class="terms-link" href="mailto:support@kiriapp.com">Customer
            ...
            Kiri , Attn.: Cancellations, P.O. Box 300940, Austin, Texas, 78703 (in
          ...
          <p class="terms-text">
            ...
            these Terms. If Kiri determines it has a legal obligation to collect a Sales
            Tax from you in connection with these Terms, Kiri will collect such Sales
            ...
            remitted the applicable Sales Tax to Kiri , you will be responsible for the
          ...
          <p class="terms-text">
            ...
            limited-use features from Kiri , referred to here as “Virtual Items.” You
            can only purchase Virtual Items through Kiri or Kiri ’s partners.
          ...
          <p class="terms-text">
            ...
            Items will terminate on the earlier of Kiri
            ceasing provision of services or your account closing or terminating. Kiri
          ...
          <p class="terms-text">
            Kiri , in its sole discretion, reserves the right to charge fees for the right
            to access or use Virtual Items and/or may distribute Virtual Items with or
            without charge. Kiri may manage, regulate, control, modify, or eliminate
            ...
            Kiri shall have no liability to you for doing so. You shall not sell, redeem,
          ...
          <p class="terms-text">
            ...
            ACKNOWLEDGE THAT Kiri IS NOT REQUIRED TO PROVIDE A
          ...
          <p class="terms-text">
            ...
            and other messages related to the App and/or the Kiri services, such as
            ...
            emailing us with your request at <a class="terms-link" href="mailto:feedback@kiridating.com">feedback@kiridating.com</a>
          </p>
          ...
          <p class="terms-text">
            ...
            retains your information, please read the       <a class="terms-link privacy"
                                                                                                                                                    href="https://kiridating.com/privacy.php">Privacy
                                                                             Policy.</a></p>
          ...
          <p class="terms-text">
            ...
            interactions with other members. The Kiri group is not
            responsible for the conduct of any user. Kiri group
          ...
          <p class="terms-text">
            All the actions you make and information you post on Kiri remain your
          ...
          <p class="terms-text">
            The foregoing provision does not require you to indemnify Kiri Group for
          ...
          <p class="terms-text">
            The Kiri Group has adopted the following policy towards copyright
            ...
            infringement (“DMCA Takedown Notice”) to Kiri Group’s Copyright
          ...
          <p class="terms-text">
            Any DMCA Takedown Notices should be sent to Kiri Group’s Copyright
            Agent at: <a class="terms-link" href="mailto:feedback@kiridating.com">feedback@kiridating.com</a>
          </p>
          ...
          <div class="terms-content-list">
            <p class="terms-text">
              1. These Terms are concluded solely between you and the Kiri
              Group and not with the providers of the Third Party Store, and the
              Kiri (and not the Third Party Store providers) is solely responsible
            ...
            <p class="terms-text">
              ...
              App. The Kiri is solely responsible for any product warranties,
            ...
            <p class="terms-text">
              3. The Kiri not the Third Party Store provider, is responsible for
              ...
              arising under consumer protection or similar legislation; and/or (iv)
              intellectual property infringement claims.
            </p>
            <p class="terms-text">
              4. The Third Party Store provider and its subsidiaries are third party
          ...
          <p class="terms-text">
            ...
            arbitrate disputes with Kiri Group and limits the manner in which
          ...
          <div class="terms-content-list">
            <p class="terms-text">
              ...
              any other aspect of your relationship with Kiri Group. It requires that,
              ...
              assert claims in small claims court if your claims qualify; and (ii) you or
              Kiri Group may seek equitable relief in court for infringement or misuse
            ...
            <p class="terms-text">
              ...
              and procedures available at: <a class="terms-link"
                                              href="https://www.jamsadr.com/rules-streamlined-arbitration/">https://www.jamsadr.com/rules-streamlined-arbitration/</a>
              . All other claims will be subject to JAMS’ most current version of
              the Comprehensive Arbitration Rules and Procedures, available at: <a class="terms-link"
                                                                                   href="https://www.jamsadr.com/rules-comprehensive-arbitration/">https://
              ...
              from JAMS, Kiri Group will pay them for you. In addition, Kiri Group
            ...
            <p class="terms-text">
              ...
              By agreeing to arbitration, YOU AND Kiri GROUP
              ARE EACH AGREEING TO WAIVE OUR RIGHTS TO A JURY TRIAL.
              Instead, you and Kiri Group are electing that all claims and disputes will
...
members after January 18, 2021.</span><br>
              ...
              decision to opt out to: <a class="terms-link" href="mailto:optout@team.Kiri.com">Kiri
              optout@team.Kiri.com</a> , within 31 days
              after first becoming subject to this Arbitration Agreement. Your notice must
              include your name and address, your Kiri username (if any), the email
              address you used to set up your Kiri account (if you have one), and an
            ...
            <p class="terms-text">
              ...
              continue, even after your relationship with Kiri Group has ended.
            </p>
          </div>
          ...
          <p class="terms-text">
            If you want to terminate these Terms, you may do so by (a) notifying Kiri
            Group at any time, and (b) closing your Account. Your notice should be sent
            to Kiri Group’s address below. Please note that if you terminate these
          ...
          <p class="terms-text">
            Kiri Group may terminate or suspend these Terms, including your
            Account, if you breach these Terms or if Kiri Group is required to do so
            by applicable law. You agree that all terminations for cause shall be made
            in Kiri Group’s sole discretion and that Kiri Group shall not be liable
            to you or any third party for any termination of your Account.
          </p>
          <p class="terms-text">
            In the event that Kiri Group determines, in its sole discretion, that you
            have breached any portion of these Terms, or have otherwise
            demonstrated conducted inappropriate for the App, Kiri Group reserves
            the right to: (a) warn you via email (to any email addresses you have
            provided to Kiri Group) that you have violated the Terms; (b) delete your
            ...
            and/or (f) pursue to any other action which Kiri Group deems to be
            appropriate.
          </p>
          ...
          <p class="terms-text">
            There are a few more things we need to mention before you can use Kiri
            .
          </p>

          <p class="terms-text">
            These Terms, which we may amend from time to time, constitute the entire
            agreement between you and the Kiri Group. The Terms supersede all
            previous agreements, representations and arrangements between us
            (written or oral), excluding the Privacy Policy. Nothing in this clause shall
            limit or exclude any liability for fraudulent misrepresentation.
          </p>
          <p class="terms-text">
            The Kiri Group has taken reasonable steps to ensure the currency,
            availability, correctness and completeness of the information contained on
            Kiri and provides that information on an "as is", "as available" basis.
            The Kiri Group does not give or make any warranty or representation of
            any kind about the information contained on Kiri , whether express or
            implied. Use of Kiri and the materials available on it is at your sole risk.
            The Kiri Group is not responsible for any loss arising from the
            transmission, use of data, or inaccurate Member Content.
          </p>
          <p class="terms-text">
            You are responsible for taking all necessary precautions to ensure that any
            material you may obtain from Kiri is free of viruses or other harmful
            components. You accept that Kiri will not be provided uninterrupted or
            error free, that defects may not be corrected or that The Kiri Group, or
            the server that makes it available, are free of viruses or bugs, spyware,
            Trojan horse or any similar malicious software. The Kiri Group is not
            responsible for any damage to your computer hardware, computer
            software, or other equipment or technology including, but without limitation
            ...
            The communications between you and Kiri Group may take place via
            electronic means, whether you use the App or send Kiri Group emails,
            or whether Kiri Group posts notices in the App or communicates with
            you via email. For contractual purposes, you (a) consent to receive
            communications from Kiri Group in electronic form; and (b) agree that
            all terms and conditions, agreements, notices, disclosures, and other
            communications that Kiri Group provides to you electronically satisfy if it
            were to be in writing. The foregoing does not affect your statutory rights,
            including but not limited to the Electronic Signatures in Global and National
            Commerce Act at 15 U.S.C. Sec. 7001 et. seq.
          </p>
          ...
          <p class="terms-text">
            As Kiri grows, we might have to make changes to these Terms so we
            reserve the right to modify, amend or change the Terms at any time (a
            ...
            Your continued use of Kiri following any Change constitutes your
            ...
            stop using Kiri immediately (uh oh, that’s going to be hard!).
          </p>
          ...
          <div class="terms-content-list">
            <p class="terms-text">
              1. you are not located in a country that is subject to a U.S. Government
          ...
          <p class="terms-text">
            By using the App, you agree and acknowledge that Kiri is a global app
            ...
            services you use, or by making use of the applications available on Kiri ,
          ...
          <div class="terms-content-list">
            ...
            <p class="terms-text">
              2. the content, products, or services on or available from such websites
              or resources.
            </p>
          </div>
          <p class="terms-text">
          ...
          <p class="terms-text">
            ...
            please contact us at <a class="terms-link" href="mailto:feedback@kiridating.com">feedback@kiridating.com</a>
          </p>
          ...
          <p class="terms-text">
            ...
            with the Kiri Group, and these Terms are governed and interpreted by
            the laws of the State of Texas. All claims arising out of or relating to these
            Terms and/or your relationship with the Kiri Group that for whatever
          ...
          <p class="terms-describe">17. Applis Group inc</p>
          <p class="terms-text">
            The Terms constitute a binding legal agreement between you as user
            (“you”) and the Applis Group inc(“we” or “us”). Applis Group inc
            includes, but is not limited to, Applis Group inc (an English company),
            Applis Group co (a California corporation), Applis Group inc
          ...
          <p class="terms-text">
            The Terms were last updated on: February 12th, 2021.
          </p>
      ...
      <div class="block-item block-cookie" data-block="#cookie">
        <div class="block-cookie-content">
          <h5 class="terms-header-title">Kiri Cookie Policy</h5>
          <p class="terms-describe-title">Introduction</p>
          <p class="terms-text">Kiri is committed to protecting your privacy. We aim to provide trustworthy,
            industry-leading products and services so that you can focus on building meaningful relationships. Our
            approach to privacy is to provide you with clear guidance and information about our data practices. That’s
            why we've tried to keep legal and technical slang to a minimum.
          </p>
          <p class="terms-text">
            This Cookie Policy explains what cookies are, what types of cookies are placed on your device when you visit
            our website and how we use them. This Cookie Policy does not address how we deal with your personal
            information generally. To learn more about how we process your personal information, please see our Privacy
            Policy here.
          </p>
          <p class="terms-describe-title">
          ...
          <p class="terms-text">
            ...
            directly by us. For example, we use first-party cookies to adapt our website to your browser’s language
            preferences and to better understand your use of our website. Third-party cookies are placed on your device
            by our partners and service providers. For example, we use third-party cookies to measure user numbers on
            our website or to enable you to share content with others across social media platforms.
          </p>
          ...
          <p class="terms-text">If your terminal is likely to display content developed using the Flash platform, we
            suggest you access your Flash cookie management tools directly via <a class="terms-link"
                                                                                  href="https://www.adobe.com">https://www.adobe.com</a>.
          </p>
          ...
          <p class="terms-text">Some features of our website and some Kiri services rely on the use of GoogleTM Maps
            ...
            <a class="terms-link long"
               href="https://www.google.com/policies/technologies/cookies/">
              https://www.google.com/policies/technologies/cookies/</a></p>
          ...
          <p class="terms-text">You can opt out of Google Analytics by visiting <a class="terms-link"
                                                                                   href="https://www.google.com/settings/ads">www.google.com/settings/ads</a>
            or by
          ...
          <p class="terms-describe">Applis Group inc </p>
      ...
      <div class="block-item block-eula" data-block="#eula">
        <div class="block-eula-content">
          <h5 class="terms-header-title">Kiri End User License Agreement</h5>
          <p class="terms-text">
            Kiri End User License Agreement ("Agreement") is a binding agreement between you ("End User" or "you") and
            Applis Group Inc. ("Company"). This Agreement governs your use of the Applis Group Supplier
            Self-Assessment (SSA) Kiri for Apple iOS or Google Android operating systems (including all related
          ...
          <p class="terms-text">
            ...
            agreement; (b) represent that you are of legal age to enter into a binding agreement; and (c) accept this
          ...
          <p class="terms-text">You acknowledge that when you
            ...
            connection with this Application is subject to our Privacy Policy https://www.Kiri Trading.com/resources/documents/mobile-app-ssa-privacy-policy/. By downloading, installing, using and
          ...
          <p class="terms-describe-title">15. Kiri has a 0 tolerance policy for objectionable content or abusive
            users.</p>
      ...
      <div class="block-item block-coming-soon" data-block="#coming">
        ...
        <div class="wrapper-block-blog-content">
          ...
          <div class="block-blog-content">
            <p class="block-blog-content-title">Coming soon</p>
            <picture>
                     <source srcset="./images/coming-table.webp" type="image/webp">
                      <img class="block-blog-content-img" src="./images/coming-table.webp" alt="Blog Photo">
            </picture>
             <picture>
                     <source srcset="./images/coming-mob.webp" type="image/webp">
